...
BAR_DIR="$HOME/.config/i3/lemonbar"

. $BAR_DIR/i3_lemonbar_config
...
$BAR_DIR/i3_workspaces.pl > "${panel_fifo}" &
...
# Conky, "SYS"
conky -c $BAR_DIR/i3_lemonbar_conky > "${panel_fifo}" &
...
cat "${panel_fifo}" | sh $BAR_DIR/i3_lemonbar_parser.sh \
